...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate an NKDA model on WikiText-103 (loss/perplexity).")

    p.add_argument("--model", type=str, required=True, help="Path to a trained NKDA HF checkpoint directory.")
    ...
    p.add_argument(
        ...
        action="store_true",
        default=False,
        help="Ablation: enable q/k l2norm inside KDA kernels (overrides checkpoint modules at runtime).",
    )
