...
from fla.models import FKDAConfig
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train a small FKDA model on WikiText-103 (HF Trainer).")
    ...
    p.add_argument("--output_dir", type=str, default="exp/fkda-wikitext103")
