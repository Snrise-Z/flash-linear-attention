...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate chunkwise MKDA on WikiText-103 (loss/perplexity).")
...
def main() -> None:
    ...
    ds = load_or_build_tokenized_split(args, tokenizer)
    dataloader = DataLoader(ds, batch_size=args.batch_size, shuffle=False, collate_fn=DefaultDataCollator())
