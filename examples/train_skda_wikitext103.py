...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train a small SKDA model on WikiText-103 (HF Trainer).")
    ...
    p.add_argument("--output_dir", type=str, default="exp/skda-wikitext103")
    ...
    # SKDA-specific knobs (keep minimal; expand as needed)
    p.add_argument("--use_qk_l2norm_in_kernel", action="store_true", default=None)
    p.add_argument("--surprise_include_margin", action="store_true", default=None)
    p.add_argument("--surprise_uncertainty_bins", type=int, default=None)
...
def main() -> None:
    ...
    if args.surprise_include_margin is not None:
        config_kwargs["surprise_include_margin"] = args.surprise_include_margin
    if args.surprise_uncertainty_bins is not None:
        config_kwargs["surprise_uncertainty_bins"] = args.surprise_uncertainty_bins
