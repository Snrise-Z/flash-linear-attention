...
from fla.models import NKDAConfig


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train a small NKDA model on WikiText-103 (HF Trainer).")
    ...
    p.add_argument("--output_dir", type=str, default="exp/nkda-wikitext103")
    ...
    p.add_argument(
        ...
        action="store_true",
        default=False,
        help="Ablation: enable q/k l2norm inside KDA kernels (may interact with NKDA normalization).",
    )
