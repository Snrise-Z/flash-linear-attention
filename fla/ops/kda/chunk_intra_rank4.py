...
def chunk_kda_rank4_fwd_intra_a_inv(
    ...
    *,
    ...
    BC = 32
    if BT != 64:
        raise ValueError(f"chunk_kda_rank4_fwd_intra_a_inv requires chunk_size=64, got {chunk_size}.")
...
def chunk_kda_rank4_bwd_mask_dAkk_within_token(
    ...
    *,
    ...
    if int(chunk_size) != 64 or BT != 64:
        raise ValueError(
            f"chunk_kda_rank4_bwd_mask_dAkk_within_token requires chunk_size=64 and dAkk[...,BT]==64, got {chunk_size=} {BT=}.",
        )
