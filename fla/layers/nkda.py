...
class NormalizedKimiDeltaAttention(nn.Module):
    """
    Normalized Kimi Delta Attention (NKDA).

    This is a KDA variant that applies a key-norm normalized update step:
        beta' = beta / (||k||^2 + eps)
    and uses the same chunk-parallel / fused-recurrent kernels by passing beta'.
    """
    ...
    def forward(
        ...
        **kwargs: Unpack[dict],
        ...
        beta = beta / k_norm_sq.to(beta.dtype)
